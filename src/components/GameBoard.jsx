    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-3 sm:p-4">
            ...
            <div className="glass-card p-4 sm:p-6 max-w-lg w-full animate-fade-in">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6 mb-5">
                ...
                <div className={`mb-4 rounded-xl border-2 px-4 py-3 text-center text-sm font-bold ${
                    isMyTurn
